...
function LoggedInNavigation() {
  return `
      <a class="menu-hover" id="summary" onclick="loadHtmlPage('content', './templates/summary.html'), toggleIsActive('summary', 'summary_img')"><img id="summary_img" src="./assets/icons/summary_grey.png" alt="Summary">Summary</a>
